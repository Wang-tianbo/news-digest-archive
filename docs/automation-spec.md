...
- 在有高信号观点时记录 AI 技术工作者、研究者、创业者和关键人物的判断、困惑、分歧与方法论
- 将结果直接提交到本仓库，供后续查阅
...
- 如果出现高信号观点、分歧、困惑或方法论，再查 AI 思想与观点观察源
...
7. 只有当观点具备长期复盘价值时，才纳入 AI 思想与观点观察
...
- 观点源只作为思想信号和判断样本，不能替代官方发布、文档、changelog 或 Release 等事实来源
- AI 思想与观点观察不是每期必写；如果当天没有高信号观点，正文省略该模块，并在结构化索引里写 `opinion_sources: []` 和 `viewpoint_themes: []`
