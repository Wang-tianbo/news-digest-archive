...
- 当中文互联网与全球范围内的 AI 技术工作者、研究者、创业者及关键人物，在博客、X、公众号、长文中表达出值得长期复盘的判断、困惑、分歧与方法论时，会作为 `AI 思想与观点观察` 纳入记录
...
- 长期跟踪中文互联网与全球范围内的 AI 技术工作者、研究者、创业者及关键人物，在博客、X、公众号、长文中表达的判断、困惑、分歧与方法论
- 观点源只作为思想信号和判断样本，不作为事实确认来源
- 如果当天没有高信号观点，不强行写入日报
...
- 如果没有高置信度新增，允许日报更短
- 观点源和事实源分开处理，人物观点不能替代一手事实确认
- 外围情报只有在能明确反作用于 AI 主线时才进入日报
- `AI 思想与观点观察` 只有在出现高信号判断、分歧或方法论时才进入日报
