...
- 当中文互联网与全球范围内的活跃 AI 博主、技术工作者、研究者、创业者及关键人物，在博客、X、公众号、长文中提供出值得记录的 AI 线索、工具发现、社区信号、判断、困惑、分歧与方法论时，会作为 `AI 思想与观点观察` 纳入记录
- 如果这些外围变量或观点样本当天没有高置信度新增，就不强行写入日报

这意味着它不是泛科技资讯仓库，而是一套“`AI 核心主线 + AI 外围关键变量 + AI 思想信号`”的情报归档系统。
...
- `AI 思想与观点观察` 可以记录高价值信息线索、观点判断、方法论或实践复盘，但必须标明类型
